...
# === Donnees a modifier =======================================================
# Ligne 27 Arborescence OU -> GS
# Ligne 60 Arborescence OU
...
# Transforme Dept/Site en jetons pour le nom de groupe de securite selon la nomenclature ! ADAPTER SELON OUs !
