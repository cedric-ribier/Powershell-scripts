...
$ExcelInput  = "C:\Windows\SYSVOL\sysvol\Chemin_Du_Fichier-Utilisatuer_A_Cree.xlsx"
$ExcelOutput = "C:\Windows\SYSVOL\sysvol\Chemenin_Du_Fichier-Nouveau_Utilisateur_Cree.xlsx"
$RootOU      = "OU=A-Renseigner,OU=A-Renseigner,DC=A-Renseigner,DC=A-Renseigner"
...
# Transforme Dept/Site en jetons pour le nom de groupe selon ta nomenclature ! ADAPTER SELON OUs !
...
                        # Départements convertis, A ADAPTER SELON ARBORESCENCE
                        switch ($Dept.ToLower()) {
                                                    "rh"        { $DeptOU = "RH" }
                                                    "info"      { $DeptOU = "Info" }
...
                        # === SAM = prenom.nom sans accents ======================================== ! MODIFIER NOM DOMAINE !
                    ...
                        $UPN = "$SAM@Nom-Du-Domaine.quelquechose"
                    ...
                        if (!$UtilisateurExiste) {
                                                    ...
                                                    # === Envoi vers partage RH ================================================ ! ADAPTER CHEMIN !
